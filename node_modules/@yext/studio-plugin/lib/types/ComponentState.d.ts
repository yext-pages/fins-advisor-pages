...
export type ComponentState = EditableComponentState | FragmentState | BuiltInState | ErrorComponentState;
export type EditableComponentState = StandardOrModuleComponentState | RepeaterState;
export type StandardOrModuleComponentState = StandardComponentState | ModuleState;
export declare enum ComponentStateKind {
    Standard = "standard",
    Module = "module",
    Fragment = "fragment",
    BuiltIn = "builtIn",
...
export type RepeaterState = {
     ...
     **/
    repeatedComponent: Omit<StandardOrModuleComponentState, "uuid" | "parentUUID"> | Omit<ErrorComponentState, "uuid" | "parentUUID">;
    /** A unique UUID for this specific component instance. */
    uuid: string;
    /** The UUID of the parent component in the tree, if one exists. */
    parentUUID?: string;
