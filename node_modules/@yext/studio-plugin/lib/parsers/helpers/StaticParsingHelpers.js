...
export default class StaticParsingHelpers {
    static addTypesToPropVal(typelessPropVal, propMetadata) {
    ...
    static parseJsxAttributes(attributes, propShape) {
        ...
        attributes.forEach((jsxAttribute) => {
            ...
            const propValue = StaticParsingHelpers.addTypesToPropVal(this.parseJsxAttribute(jsxAttribute), propMetadata);
    ...
    static parseJsxAttribute(jsxAttribute) {
        this.assertIsJsxAttribute(jsxAttribute);
        const { value, kind } = StaticParsingHelpers.parseInitializer(jsxAttribute.getInitializerOrThrow());
