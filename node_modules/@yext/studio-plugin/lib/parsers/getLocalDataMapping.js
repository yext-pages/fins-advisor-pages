 ...
 */
export default async function getLocalDataMapping(localDataPath) {
    ...
    if (!existsSync(localDataMappingFilepath)) {
        throw new Error(`The localData's ${streamMappingFile} does not exist, expected the file to be at "${localDataMappingFilepath}".`);
    }
...
//# sourceMappingURL=getLocalDataMapping.js.map