 ...
 */
export default async function createStudioPlugin(args) {
    ...
    const localDataMapping = studioConfig.isPagesJSRepo
        ...
        : undefined;
    const orchestrator = new ParsingOrchestrator(tsMorphProject, studioConfig, localDataMapping);
    const hmrManager = new HmrManager(orchestrator, pathToUserProjectRoot, studioConfig.paths);
    const fileSystemManager = new FileSystemManager(studioConfig.paths, new FileSystemWriter(orchestrator, tsMorphProject));
    return {
        ...
        buildStart() {
            ...
            const watchUserFiles = (userPaths) => {
        ...
        configureServer: createConfigureStudioServer(fileSystemManager, gitWrapper, orchestrator),
        handleHotUpdate: createHandleHotUpdate(hmrManager),
    };
}
//# sourceMappingURL=createStudioPlugin.js.map