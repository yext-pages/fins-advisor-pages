...
class CookieManager {
     ...
     */
    forEachDomainIncreasingSpecificity(func) {
     ...
     */
    removeCookieByDomain(cookieDomain) {
     ...
     */
    static listDifference(superlist, sublist) {
     ...
     */
    persistentCookies() {
        return this.allCookies().filter(val => val !== constants_1.COOKIE_REMOVAL_VALUE);
    }
    /**
     ...
     */
    forEachCookieNameValue(nameValueFunc) {
        this._outerDocument.cookie.split(';').forEach((cookie) => {
            const keyValue = cookie.split('='), key = keyValue[0], value = keyValue[1];
            if (key && value) {
     ...
     */
    setCookieAndRemoveOldCookies(cookieValue) {
        ...
        this.forEachDomainIncreasingSpecificity(domain => {
            if (rootDomainReached) {
                if (this.removeCookieByDomain(domain))
     ...
     */
    setCookie(cookieValue, cookieDomain) {
        this._outerDocument.cookie = this.formatCookie(models_1.COOKIE_PARAM, cookieValue, cookieDomain);
    }
    /**
     ...
     */
    formatCookie(cookieName, cookieValue, domain, path = '/') {
     ...
     */
    clearCookie(cookieDomain = '', cookiePath = '/') {
        const epoch = new Date(0);
        let cookieString = models_1.COOKIE_PARAM + '=' + constants_1.COOKIE_REMOVAL_VALUE;
