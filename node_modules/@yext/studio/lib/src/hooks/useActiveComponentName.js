...
export default function useActiveComponentName() {
    const getActiveComponentState = useStudioStore((store) => store.actions.getActiveComponentState);
...
export function getComponentDisplayName(componentState) {
...
//# sourceMappingURL=useActiveComponentName.js.map