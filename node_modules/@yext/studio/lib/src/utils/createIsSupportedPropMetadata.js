 ...
 */
export default function createIsSupportedPropMetadata(componentName) {
    return function isSupportedPropMetadata(entry) {
        const [propName, propMetadata] = entry;
        if (propMetadata.type === PropValueType.ReactNode) {
            console.warn(`Found ${propName} in component ${componentName} with PropValueType.ReactNode.` +
...
//# sourceMappingURL=createIsSupportedPropMetadata.js.map