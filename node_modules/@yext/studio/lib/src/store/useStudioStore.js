...
const useStudioStore = create()(storeMiddlewares(withLenses((set, get) => {
    return {
        ...
        actions: new StudioActions(() => get().pages, () => get().fileMetadatas, () => get().siteSettings, () => get().previousSave, () => get().studioConfig),
        studioConfig: lens(createStudioConfigSlice),
    };
})));
void setInitialAsyncState(useStudioStore);
export default useStudioStore;
//# sourceMappingURL=useStudioStore.js.map