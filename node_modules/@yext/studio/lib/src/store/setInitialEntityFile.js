 ...
 */
export default async function setInitialEntityFile(useStudioStore) {
    ...
    if (firstAcceptedEntityFile) {
        const localDataFolder = useStudioStore.getState().studioConfig.paths.localData;
        await pageSlice.setActiveEntityFile(localDataFolder, firstAcceptedEntityFile);
    }
}
//# sourceMappingURL=setInitialEntityFile.js.map