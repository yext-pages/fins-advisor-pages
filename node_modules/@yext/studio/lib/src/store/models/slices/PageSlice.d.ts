import { ComponentState, ErrorPageState, GetPathVal, ModuleMetadata, PageState } from "@yext/studio-plugin";
...
interface PageSliceActions {
    ...
    setActiveEntityFile: (parentFolder: string, activeEntityFile?: string) => Promise<void>;
...
//# sourceMappingURL=PageSlice.d.ts.map