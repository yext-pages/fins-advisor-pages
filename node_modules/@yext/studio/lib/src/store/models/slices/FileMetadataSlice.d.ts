import { ComponentMetadata, ComponentState, FileMetadata, ModuleMetadata, ValidFileMetadata } from "@yext/studio-plugin";
...
export interface FileMetadataSliceActions {
    setFileMetadata: (metadataUUID: string, fileMetadata: ValidFileMetadata) => void;
...
//# sourceMappingURL=FileMetadataSlice.d.ts.map