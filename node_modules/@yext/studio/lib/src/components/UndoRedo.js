...
export default function UndoRedo() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { className: undoClasses, onClick: handleUndo, disabled: disableUndo, "aria-label": "Undo", children: _jsx(Undo, {}) }), _jsx("button", { className: redoClasses, onClick: handleRedo, disabled: disableRedo, "aria-label": "Redo", children: _jsx(Undo, {}) })] }));
}
