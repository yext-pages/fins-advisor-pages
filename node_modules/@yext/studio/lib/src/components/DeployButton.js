...
export default function DeployButton() {
    ...
    return (_jsxs("button", { className: "ml-4 py-1 px-3 text-white rounded-md disabled:bg-gray-400 bg-blue-600 hover:bg-blue-500", onClick: handleClick, disabled: isDisabled, "aria-label": "Deploy Changes to Repository", children: [_jsx("span", { id: tooltipAnchorID, children: "Deploy" }), isDisabled && gitData.canPush.reason && (_jsx(Tooltip, { className: "z-20", anchorId: tooltipAnchorID, content: gitData.canPush.reason }))] }));
}
//# sourceMappingURL=DeployButton.js.map