...
export default function Highlighter() {
    ...
    const isErrorState = useStudioStore((store) => store.actions.getActiveComponentState()?.kind === ComponentStateKind.Error);
    ...
    return (_jsx("div", { style: style, children: _jsx("div", { style: tagStyle, children: componentName }) }));
}
