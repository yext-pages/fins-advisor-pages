...
export declare type NarrowingPredicate<T, U extends T> = (element: T, index: number, array: T[]) => element is U;
/**
 ...
 */
export declare function find<T, U extends T>(predicate: NarrowingPredicate<T, U>, array: T[]): Maybe<U>;
export declare function find<T, U extends T>(predicate: NarrowingPredicate<T, U>): (array: T[]) => Maybe<U>;
