...
describe("createLens", function () {
    it("returns a scoped set/get pair", function () {
        var store = (0, vanilla_1.default)(function (set, get) {
...
describe("immer", function () {
    it("works out-of-the-box", function () {
        var store = (0, vanilla_1.default)()((0, immer_1.immer)((0, _1.withLenses)(function () { return ({
...
describe("lens", function () {
    it("calls creator function with (set, get, api, path)", function () {
        var store = (0, vanilla_1.default)((0, _1.withLenses)(function (storeSet, storeGet, storeApi) { return ({
            sub: (0, _1.lens)(function (set, get, api, path) {
    ...
    it("doesn`t throw an error if created outside `withLenses` function", function () {
        ...
        var useStore = (0, vanilla_1.default)((0, _1.withLenses)(function () { return ({
...
describe("withLenses", function () {
    it("also accepts an object config", function () {
        var store = (0, vanilla_1.default)((0, _1.withLenses)({
    ...
    it("preserves Symbols", function () {
        var _a;
        var symbol = Symbol();
        var store = (0, vanilla_1.default)((0, _1.withLenses)((_a = {
